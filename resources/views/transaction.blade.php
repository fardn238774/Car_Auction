...
<div class="receipt shine">
    ...
    <table>
        <tr><td>Car</td><td>{{ $car->car_name }}</td></tr>
        <tr><td>Auction Location</td><td>{{ $auction->auction_location }}</td></tr>
        <tr><td>Auction Date</td><td>{{ \Carbon\Carbon::parse($auction->auction_date)->format('d M, Y') }}</td></tr>
        <tr><td>Start Time</td><td>{{ $auction->start_time }}</td></tr>
        <tr><td>End Time</td><td>{{ $auction->end_time }}</td></tr>
        <tr><td>Winning Amount</td><td>${{ $bid->bid_amount }}</td></tr>
        <tr><td>Bid Placed At</td><td>{{ \Carbon\Carbon::parse($bid->bid_time)->format('d M, Y H:i:s') }}</td></tr>
    </table>
