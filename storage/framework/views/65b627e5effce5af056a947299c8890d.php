...
<div class="car-list">
    <?php $__empty_1 = true; $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="car-card">
            <img src="<?php echo e(filter_var($car->car_image, FILTER_VALIDATE_URL) ? $car->car_image : asset('storage/' . $car->car_image)); ?>" alt="<?php echo e($car->car_name); ?>">
            <div class="car-name"><?php echo e($car->car_name); ?></div>
            <div class="car-specs"><?php echo e($car->car_specs); ?></div>
            <div class="starting-bid">Starting Bid: ৳<?php echo e(number_format($car->starting_bid, 2)); ?></div>
            <a href="<?php echo e(route('cars.goToAuction', $car->id)); ?>" class="inspect-btn">Go to Auction</a>
        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel_Car_Project/resources/views/view.blade.php ENDPATH**/ ?>