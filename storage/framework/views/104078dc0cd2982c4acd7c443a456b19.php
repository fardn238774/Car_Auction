...
<body>
    <div class="container">
        <h2>Rate <?php echo e($organization['name']); ?></h2>
        <form action="<?php echo e(url('submit-rating')); ?>" method="post">
            <?php echo csrf_field(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel_Car_Project/resources/views/rating.blade.php ENDPATH**/ ?>