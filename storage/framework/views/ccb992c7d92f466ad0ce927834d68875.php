...
<div class="add-car-form">
    <form action="<?php echo e(route('admin.storeCar')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<div class="car-grid">
    ...
    <div class="car-card">
        <img src="<?php echo e($car->image_url ?? 'https://via.placeholder.com/300x180?text=No+Image'); ?>" alt="<?php echo e($car->name); ?>">
        <div class="car-card-body">
            <h5><?php echo e($car->name); ?> (<?php echo e($car->model); ?>)</h5>
            ...
            <div class="car-card-actions">
                <a href="<?php echo e(route('admin.editCar', $car->id)); ?>" class="edit">Edit</a>
                <a href="<?php echo e(route('admin.deleteCar', $car->id)); ?>" onclick="return confirm('Are you sure?')" class="delete">Delete</a>
            </div>
        </div>
    </div>
