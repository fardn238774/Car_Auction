...
<div class="auction-list">
    <?php $__empty_1 = true; $__currentLoopData = $auctions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $auction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <a href="<?php echo e(route('auction.view', $auction->id)); ?>" style="text-decoration:none;">
            <div class="auction-item">
                <p><strong>Location:</strong> <?php echo e($auction->auction_location); ?></p>
                <p><strong>Capacity:</strong> <?php echo e($auction->capacity); ?></p>
                <p><strong>Date:</strong> <?php echo e(\Carbon\Carbon::parse($auction->auction_date)->format('d M, Y')); ?></p>
                <p><strong>Start Time:</strong> <?php echo e($auction->start_time); ?></p>
                <p><strong>End Time:</strong> <?php echo e($auction->end_time); ?></p>
            </div>
        </a>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel_Car_Project/resources/views/Time.blade.php ENDPATH**/ ?>